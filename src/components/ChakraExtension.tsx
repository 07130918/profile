...
export const DynamoDBIcon = (props: any) => <SiAmazondynamodb size={24} {...props} />;
export const GCPIcon = (props: any) => <SiGooglecloud size={24} color='#4285F4' {...props} />;
export const JavaScriptIcon = (props: any) => <SiJavascript size={24} {...props} />;
...
export const NextJsIcon = (props: any) => <TbBrandNextjs size={24} {...props} />;
export const PythonIcon = (props: any) => <FaPython size={24} {...props} />;
export const ReactIcon = (props: any) => <FaReact size={24} {...props} />;
export const TypeScriptIcon = (props: any) => <SiTypescript size={24} {...props} />;
...
export const TabContainer = (props: BoxProps) => (
    <Box p={4} borderRadius='lg' borderColor='#333333' borderWidth='1px' {...props} />
);
