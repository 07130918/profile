export const text = {
    en: {
        introduction: {
            greeting: "Hello there, my name is Kota and I'm a software developer by profession.",
            work: {
                at: 'I specialize in software engineering and currently work as a software engineer at ',
                inc: 'Arara Inc. ',
            },
            major: 'Interestingly, my educational background is in city planning, which I studied for 4 years at university.',
            study: 'The study of structural mechanics and surveying was particularly enriching and has been invaluable in my career.',
            current:
                "I'm currently focused on web application development. I find joy in exploring new technologies and ideas, and bringing them to life.",
    ...
    ja: {
        introduction: {
            ...
            work: {
                at: '私はソフトウェアエンジニアリングを専門とし、現在',
                inc: 'アララ株式会社',
            },
            major: 'でソフトウェアエンジニアとして働いています。大学在学中には都市計画を専攻していました。',
            study: '特に構造力学と測量学について学ぶことは私にとって貴重な経験でした。',
            current:
                '現在、私はwebアプリの開発に取り組んでいます。新しい技術やアイデアを探求し、それを具現化することに喜びを感じています。(このページも好奇心で作りました!)🧑🏻‍💻',
            travel: '旅行が大好きです! 🇯🇵 🇬🇧 🇸🇬 🇻🇳 🇦🇺 🇵🇭',
            satisfaction: '新しい場所や文化を探索することが、好奇心と探究心が満たします!',
